...
- Mặc định tạo bản ghi ở tùy chọn `Gửi thẻ`; chọn `Lấy thẻ` để tạo dòng lấy thẻ và tự trừ thẻ khỏi số đang giữ của khách.
...
Schema chính gồm: `fullName`, `phone`, `depositDate`, `depositTime`, `cardAction`, `cards`, `balls`, `totalText`, `status`, `createdAt`, `updatedAt`, `createdByName`, `updatedByName`, `history[]`.
