        ...
        <section className="space-y-4 px-3 py-4 pb-8 sm:px-4 lg:space-y-5 lg:px-6">
          ...
          <section className="grid grid-cols-2 gap-3 md:grid-cols-4">
            <button
              ...
              className="rounded-lg border border-[#E5E7EB] bg-white p-4 text-left shadow-sm transition hover:border-[#CBD5E1] hover:bg-[#F8FAFC] focus:outline-none focus:ring-2 focus:ring-[#64748B]/30 sm:p-5 text-[#111827] dark:text-[#f5f5f7]"
